...
public class ClockPane extends Pane{
	...
	protected void paintClock() {
		...
		//Draw a circle
		Circle circle = new Circle(centerX, centerX, clockRadius);
		circle.setFill(Color.WHITE);
		circle.setStroke(Color.BLACK);
		Text test1 = new Text(centerX - 5, centerY - clockRadius +12, "12");
		...
		double miunteY = centerY - mLength * Math.cos(minute * (2 * Math.PI / 60));
		Line mLine = new Line(centerX, centerY, minuteX, miunteY);
		...
		getChildren().clear();
		getChildren().addAll(circle, test1, text2, text3, text4, sLine, mLine, hline);
	}
